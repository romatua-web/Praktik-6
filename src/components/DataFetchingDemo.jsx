  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        // Data dummy users
        const dummyUsers = [
          { id: 1, name: 'Romatua Siumorang', email: 'romatua@example.com' },
          { id: 2, name: 'Romatua', email: 'romae@example.com' },
          { id: 3, name: 'Roma', email: 'romlagi@example.com' },
          { id: 4, name: 'RomTu', email: 'romtuaa@example.com' },
        ];
